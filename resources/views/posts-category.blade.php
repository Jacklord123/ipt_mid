...
<div class="container" style="background-color: lightwhite">
  <h1 class="text-black pt-2 pb-2">{{$category->category}} Post</h1>
  <hr>
  @foreach($posts as $p)
  ...
  @endif
    <div class="card-body">
      ...
      <h5 class="card-title pb-3"><i class="fas fa-user-circle"></i> {{$p->user->name}}</h5>
